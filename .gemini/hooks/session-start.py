#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Gemini SessionStart hook for Elaina.

OpenSpec is the active workflow authority. This hook injects only a compact
pointer to optional Trellis conventions so legacy Trellis task flow cannot
misroute a new session.
"""
...
def _should_skip_injection() -> bool:
    return (
        ...
        or os.environ.get("GEMINI_NON_INTERACTIVE") == "1"
    )
