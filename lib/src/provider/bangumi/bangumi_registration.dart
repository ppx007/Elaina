...
ProviderRegistration bangumiProviderRegistration() {
  return const ProviderRegistration(
    ...
    ratePolicy: ProviderRatePolicy(maxRequests: 6, window: Duration(seconds: 1)),
    retryPolicy: ProviderRetryPolicy(maxAttempts: 3, initialBackoff: Duration(milliseconds: 300)),
