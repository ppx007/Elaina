...
ProviderRegistration dandanplayProviderRegistration() {
  return const ProviderRegistration(
    ...
    ratePolicy: ProviderRatePolicy(maxRequests: 4, window: Duration(seconds: 1)),
    retryPolicy: ProviderRetryPolicy(maxAttempts: 3, initialBackoff: Duration(milliseconds: 500)),
