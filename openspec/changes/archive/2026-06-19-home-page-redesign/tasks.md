...
- [x] 3.1 Implement the auto-sliding Hero Carousel widget as a replacement for the static `_buildHeroBanner`.
- [x] 3.2 Implement the "Hot Updates" horizontal carousel with navigation arrows to replace `_buildHotUpdatesList`.
- [x] 3.3 Update the "More Recommendations" grid to match the reference's dark glass aesthetic and typography.
