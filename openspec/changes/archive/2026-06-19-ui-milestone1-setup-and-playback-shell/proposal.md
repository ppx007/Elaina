...
- **Design System & Theme**: Establish a centralized `ElainaTheme` under `lib/src/ui/theme/` to manage colors (dark glassmorphism), spacing, typography, and visual assets without magic values.
