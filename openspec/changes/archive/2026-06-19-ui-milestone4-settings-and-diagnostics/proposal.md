...
- **Diagnostics Center Integration**: Connect the screen to [DiagnosticsCenterRuntime](file:///D:/CodeWork/pkpk/lib/src/foundation/diagnostics/diagnostics_center_runtime.dart) to display telemetry.
