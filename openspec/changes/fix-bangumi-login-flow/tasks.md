...
- [x] 2.2 Add provider helpers for the Bangumi OAuth authorization URI without
...
- [x] 3.1 Change tracking-page login actions to open the Bangumi OAuth
  authorization page instead of only navigating to settings.
...
- [x] 4.1 Add focused tests for OAuth authorization URI construction, login dispatch,
