# desktop-diagnostics-dashboard Specification
...
- **AND** displays the latest AV sync drift values from [AVSyncGuard](file:///D:/CodeWork/pkpk/lib/src/playback/av_sync_guard.dart)
...
- **THEN** the UI renders a table of recent events, timestamps, and details retrieved from [DiagnosticsCenterRuntime](file:///D:/CodeWork/pkpk/lib/src/foundation/diagnostics/diagnostics_center_runtime.dart)
