# desktop-downloads-tracking Specification
...
- **THEN** it renders progress bars, download speed (in MB/s), active peer counts, and status indicators fetched from [BtTaskCoreRuntime](file:///D:/CodeWork/elaina/lib/src/streaming/bt_task_core_runtime.dart)
