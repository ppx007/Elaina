# desktop-rss-feed Specification

## Purpose
TBD - created by archiving change ui-milestone3-rss-engine-and-downloads. Update Purpose after archive.
## Requirements
...
- **THEN** it displays a list of active feed subscriptions retrieved from [RssEngineRuntime](file:///D:/CodeWork/pkpk/lib/src/domain/rss/rss_engine_runtime.dart)
...
- **THEN** the UI updates the feed's download policy in [RssAutoDownloadPolicy](file:///D:/CodeWork/pkpk/lib/src/provider/rss/rss_auto_download_policy.dart)
