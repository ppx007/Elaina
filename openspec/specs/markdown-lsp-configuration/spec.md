# markdown-lsp-configuration Specification

## Purpose
Define how Markdown file extensions are registered with the loaded OpenCode/OMO LSP configuration, including fallback command selection and verification requirements.
## Requirements
