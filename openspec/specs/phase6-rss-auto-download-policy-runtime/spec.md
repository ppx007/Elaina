# phase6-rss-auto-download-policy-runtime Specification

## Purpose
Runtime acceptance layer for RSS auto-download policy — bootstrap, scoped projections, typed outcomes, restart replay, dispose/unavailable/capability gates.
## Requirements
