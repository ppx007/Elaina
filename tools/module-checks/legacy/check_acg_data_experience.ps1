...
$requiredFiles = @(
  ...
  'tools/runtime_checks/acg_experience_runtime_contract.dart',
  'tools/runtime_checks/playback_metadata_bridge_runtime_contract.dart',
...
$forbiddenUiTerms = @(
  ...
  'ProviderGateway',
  'ProviderContract',
  'package:elaina/src/provider/bangumi',
  'package:elaina/src/provider/dandanplay'
)
