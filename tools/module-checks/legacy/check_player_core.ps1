...
$smokeGateScript = Get-Content -LiteralPath (Join-Path $PSScriptRoot 'check_player_smoke_gate.ps1') -Raw
...
& dart (Join-Path $root 'tools/runtime_checks/player_core_runtime_contract.dart')
