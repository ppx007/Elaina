...
$requiredFiles = @(
    ...
    "$root\tools\runtime_checks\rss_auto_download_runtime_contract.dart"
)
...
dart run "$root\tools\runtime_checks\rss_auto_download_runtime_contract.dart"
...
# --- Checker terms ---
$checker = "$root\tools\runtime_checks\rss_auto_download_runtime_contract.dart"
