...
$requiredFiles = @(
    ...
    "$root\tools\runtime_checks\webview_session_backfill_runtime_contract.dart"
)
...
dart run "$root\tools\runtime_checks\webview_session_backfill_runtime_contract.dart"
...
# --- Checker terms ---
$checker = "$root\tools\runtime_checks\webview_session_backfill_runtime_contract.dart"
